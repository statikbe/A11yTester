...
console.log("This is a change in the file");
    ...
    plugins: [
      {
        ...
        selector: "[data-modal-image]",
      },
      {
        path: "modal",
        file: "video.plugin",
        name: "VideoModalPlugin",
        selector: "[data-modal-video]",
      },
      {
        path: "modal",
        file: "ajax.plugin",
        name: "AjaxModalPlugin",
        selector: "[data-modal-ajax]",
      },
      {
        path: "modal",
...
components.forEach(
  (component: { name: string; selector: string; plugins?: any[] }) => {
